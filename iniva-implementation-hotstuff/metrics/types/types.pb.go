...
type QCLength struct {
	...
	Event       *Event `protobuf:"bytes,1,opt,name=Event,proto3" json:"Event,omitempty"`
	AvgQCLength uint64 `protobuf:"varint,2,opt,name=AvgQCLength,proto3" json:"AvgQCLength,omitempty"`
}

func (x *QCLength) Reset() {
	*x = QCLength{}
	if protoimpl.UnsafeEnabled {
...
func (x *QCLength) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QCLength) ProtoMessage() {}

func (x *QCLength) ProtoReflect() protoreflect.Message {
	mi := &file_metrics_types_types_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QCLength.ProtoReflect.Descriptor instead.
func (*QCLength) Descriptor() ([]byte, []int) {
	return file_metrics_types_types_proto_rawDescGZIP(), []int{5}
}

func (x *QCLength) GetEvent() *Event {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *QCLength) GetAvgQCLength() uint64 {
	if x != nil {
...
var file_metrics_types_types_proto_rawDesc = []byte{
	...
	0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x73, 0x22, 0x50, 0x0a, 0x08, 0x51, 0x43, 0x4c, 0x65,
	0x6e, 0x67, 0x74, 0x68, 0x12, 0x22, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x52, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x76, 0x67, 0x51,
	0x43, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x41,
	0x76, 0x67, 0x51, 0x43, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69,
...
var file_metrics_types_types_proto_depIdxs = []int32{
	...
	1, // 6: types.QCLength.Event:type_name -> types.Event
