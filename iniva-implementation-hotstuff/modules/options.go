...
// ShouldUseIniva returns true if the Iniva signature aggregation protocol should be used.
func (opts *Options) ShouldUseIniva() bool {
	return opts.shouldUseIniva
}
...
// SetShouldUseIniva sets the ShouldUseIniva setting to true.
func (opts *Options) SetShouldUseIniva() {
	opts.shouldUseIniva = true
}
